...
class StudentMarks(models.Model):
    ...
    student=models.ForeignKey(Student,on_delete=models.DO_NOTHING,related_name='studentmarks')
    created_datetime = models.DateTimeField(blank=True, null=True)
    modified_datetime = models.DateTimeField(blank=True, null=True)
...
class Department(models.Model):
    ...
    degree=models.ForeignKey(Degree,on_delete=models.DO_NOTHING,related_name='++')
    created_datetime = models.DateTimeField(blank=True, null=True)
...
class Certificates(models.Model):
    id=models.BigAutoField(primary_key=True)
    user=models.ForeignKey(Users,on_delete=models.DO_NOTHING,related_name='++',to_field='id',db_column='issuer_id')
    ...
    student=models.ForeignKey(Student,on_delete=models.DO_NOTHING,related_name='+')
    department=models.ForeignKey(Department,on_delete=models.DO_NOTHING,related_name='+')
    course=models.ForeignKey(Course,on_delete=models.DO_NOTHING,related_name='+')
    is_verified=models.BooleanField(default=False)
    certificate_id=models.CharField(max_length=255)
    certificatetype=models.ForeignKey(Certificatetype,on_delete=models.DO_NOTHING,related_name='+')
